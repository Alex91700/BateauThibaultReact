...
class Vue31 extends React.Component {
  ...
  render(){
    return (
        ...
        <View style={{ flex: 2, justifyContent: 'center'}}>
               <Text style={styles.title}>Les fous de l'île </Text>
        </View>
        <View style={{ flex: 3 }}>
               <Image style={styles.image}  source={require('../assets/fousDeLIle.png')} />
        </View>
...
Vue31.contextType = ThemeContext;

export default Vue31;
